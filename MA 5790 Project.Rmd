...
#Resampling the data
```{r resampling}
svm_fit <- train(Divorce_Y_N ~., data = train_data, method = "svmRadial", preProc = c("BoxCox", "pca"), tuneLength = 10, trControl = trainControl(method = "repeatedcv", repeats  = 5))

knn_fit <- train(Divorce_Y_N ~., data = train_data, method = "knn", preProc = c("BoxCox", "pca"), tuneLength = 5, trControl = trainControl(method = "repeatedcv", repeats  = 5))
```
