...
#Spending the data
```{r Balanced or Unbalanced Response variable}
class_frequency <- table(data_raw$Divorce_Y_N)
barplot(class_frequency, ylab='count',xlab='Outcome',main='Balance of Outcome')
```
