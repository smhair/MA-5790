...
trans <- preProcess(data_trans1, method = c("BoxCox", "center", "scale", "pca"))

trans$dim
t=as.data.frame(trans$rotation)
str(t)
screeplot(t)
